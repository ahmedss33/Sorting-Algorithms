...
##################### IN-PLACE QUICK SORT - REVERSE SORTED ###############################
def quickSort(items):
...
##################### MODIFIED QUICK SORT - REVERSE SORTED ###############################
...
sort=sorted(numbers,key=int, reverse=True)
alist = sort

####################### CALLING INSERTION SORT - REVERSE SORTED ##########################
...
########################### CALLING MERGE SORT - REVERSE SORTED ##########################
...
print('\n-----------------------------------------------------------------------')
################## CALLING IN-PLACE QUICK SORT - REVERSE SORTED ##########################
...
print('\n-----------------------------------------------------------------------')
##################### CALLING MODIFIED QUICK SORT - REVERSE SORTED ##############################
